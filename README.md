...
* **No virtual DOM:** Because, let's face it, a virtual DOM is an overhead if you don't need it. In Active CSS, only the content you want updating gets updated - same as any other framework that uses a virtual DOM. You can use your old plugins, and you know where you are with the DOM at any one time.
