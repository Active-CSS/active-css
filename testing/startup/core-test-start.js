...
describe('Set up core to test', function() {
	beforeAll(async function() {
		...
		await ActiveCSS.init({
			configLocation: '/base/testing/startup/compiled/core-test-config.acss'	// *Never* edit this file directly. It is auto-generated from the tests dir.
		});
	});
  	...
  	it('should verify the results from the Active CSS tests', function(done) {
		...
		setTimeout(function() {
			...
			if (listOfTestElements.length == 0) {
				...
				// window.testsRun is set up in the Active CSS config. See /testing/tests/core-test-config-base.acss.
