...
(function (global, document) {
	...
	_a.CreateElement = function (o) {
		...
		if (attrs) {
			...
			'this.setAttribute(name + \'-old\', oldVal); ' + 'let ref = this.getAttribute(\'data-activeid\').replace(\'d-\', \'\') + \'HOST\' + name;' + 'ActiveCSS._varUpdateDom([{currentPath: ref, previousValue: oldVal, newValue: newVal, type: \'update\'}]);' + '_handleEvents({ obj: this, evType: \'attrChange-\' + name });' + '}';
		}
  ...
  */
	...
	_a.StopImmediatePropagation = function (o) {
		...
		if (_typeof(o.obj) == 'object') o.obj.activeStopProp = true;
	};
	...
	_a.Var = function (o) {
		...
		console.log('_a.Var, set ' + scopedVar + ' to ');
		console.log(expr);
  ...
  */
   ...
   */
	...
	var _splitIframeEls = function _splitIframeEls(sel) {
		...
		var targSel = void 0,
		    iframeID = void 0;
		var root = relatedObj && (typeof relatedObj === 'undefined' ? 'undefined' : _typeof(relatedObj)) == 'object' ? _getRootNode(relatedObj) : null;
		var doc = document,
		    hostIsShadow = false,
		    splitSel = false;
  ...
  */
				...
				try {
					for (var _iterator17 = attrs[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
						...
						switch (attr.nodeName) {
							case 'class':
								console.log('_replaceScopedVars, setting class to ' + newAttr);
								treeWalker.currentNode.classList = newAttr;
								break;
							case 'id':
								treeWalker.currentNode.id = newAttr;
								break;
							default:
	...
	var _resolveAjaxVarsDecl = function _resolveAjaxVarsDecl(res, shadScope) {
  ...
  */
		...
		try {
			for (var _iterator18 = changes[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
				...
				if (_typeof(change.previousValue) == 'object' || _typeof(change.newValue) == 'object') {
					...
					try {
						for (var _iterator19 = changeDiff[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
							innerChange = _step19.value;
	...
	var _varUpdateDomDo = function _varUpdateDomDo(change, dataObj) {
		var refObj = void 0,
		    cid = void 0,
		    el = void 0,
		    pos = void 0,
		...
		for (cid in dataObj.attrs) {
			...
			try {
				for (var _iterator20 = Object.entries(dataObj.attrs[cid])[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
					var _ref5 = _step20.value;
					...
					while (el.parentNode) {
						...
						if (el) {
							if (supportsShadow && el instanceof ShadowRoot) {
								...
								el = el.host;
								var thisRootEl = _getRootNode(el);
 ...
 */
	...
	var _appendURIPar = function _appendURIPar(url, pars, doc) {
		...
		try {
			for (var _iterator21 = parsArr[Symbol.iterator](), _step21; !(_iteratorNormalCompletion21 = (_step21 = _iterator21.next()).done); _iteratorNormalCompletion21 = true) {
				thisPar = _step21.value;
	...
	var _composedPath = function _composedPath(e) {
  ...
  */
		...
		try {
			for (var _iterator22 = strArr[Symbol.iterator](), _step22; !(_iteratorNormalCompletion22 = (_step22 = _iterator22.next()).done); _iteratorNormalCompletion22 = true) {
				item = _step22.value;
	...
	var _getRootNode = function _getRootNode(obj) {
	...
	var _outDebug = function _outDebug(showErrs, errs) {
		if (showErrs) {
			...
			try {
				for (var _iterator24 = errs[Symbol.iterator](), _step24; !(_iteratorNormalCompletion24 = (_step24 = _iterator24.next()).done); _iteratorNormalCompletion24 = true) {
					err = _step24.value;
	...
	// MIT license.
	!function (e, t) {
		"object" == (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) && "object" == (typeof module === 'undefined' ? 'undefined' : _typeof(module)) ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) ? exports.recursiveDiff = t() : e.recursiveDiff = t();
		...
		return function (e) {
			...
			var _n = n(1),
			    ...
			    i = _n.errors,
			    l = n(2),
			    f = (_f = {}, _defineProperty(_f, r.NUMBER, l.isNumber), _defineProperty(_f, r.BOOLEAN, l.isBoolean), _defineProperty(_f, r.STRING, l.isString), _defineProperty(_f, r.DATE, l.isDate), _defineProperty(_f, r.UNDEFINED, l.isUndefined), _defineProperty(_f, r.NULL, l.isNull), _defineProperty(_f, r.ARRAY, l.isArray), _defineProperty(_f, r.MAP, l.isMap), _defineProperty(_f, r.SET, l.isSet), _defineProperty(_f, r.ITERABLE_OBJECT, l.isIterableObject), _f),
			    u = _defineProperty({}, r.DATE, l.areDatesEqual);

			function a(e) {
				var t = Object.keys(f);var n = r.DEFAULT;for (var _r = 0; _r < t.length; _r += 1) {
					if (f[t[_r]](e)) {
						n = t[_r];break;
					}
				}return n;
			}function s(e, t, n, o) {
				var i = void 0;return n === r.UNDEFINED && o !== r.UNDEFINED ? i = "add" : n !== r.UNDEFINED && o === r.UNDEFINED ? i = "delete" : !function (e, t, n, r) {
					return n === r && (u[n] ? u[n](e, t) : e === t);
				}(e, t, n, o) ? i = "update" : l.noop(), i;
			}function c(e, t, n, i, l) {
				var f = a(e),
				    u = a(t),
				    p = i || [],
				    d = l || [];if (function (e, t) {
					return e === t && o.indexOf(e) >= 0;
				}(f, u)) {
					var _o = function (e, t, n) {
						var o = void 0;return n === r.ITERABLE_OBJECT ? o = new Set(Object.keys(e).concat(Object.keys(t))) : n === r.ARRAY && (o = e.length > t.length ? new Array(e.length) : new Array(t.length), o = o.fill(0, 0), o = o.map(function (e, t) {
							return t;
						}), o = new Set(o)), o;
					}(e, t, f).values();var _i = _o.next().value;for (; null != _i;) {
						c(e[_i], t[_i], n, p.concat(_i), d), _i = _o.next().value;
					}
				} else {
					var _r2 = s(e, t, f, u);null != _r2 && d.push(function (e, t, n, r, o) {
						var i = { op: n, path: r };return "add" !== n && "update" !== n || (i.val = t), o && "add" !== n && (i.oldVal = e), i;
					}(e, t, _r2, i, n));
				}return d;
			}var p = { add: l.setValueByPath, update: l.setValueByPath, delete: l.deleteValueByPath };e.exports = { getDiff: function getDiff(e, t) {
					var n = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : !1;
					return c(e, t, n);
				}, applyDiff: function applyDiff(e, t, n) {
					return function (e, t, n) {
						if (!(t instanceof Array)) throw new Error(i.INVALID_DIFF_FORMAT);var r = e;return t.forEach(function (e) {
							var t = e.op,
							    o = e.val,
							    l = e.path;
							if (!p[t]) throw new Error(i.INVALID_DIFF_OP);r = p[t](r, l, o, n);
						}), r;
					}(e, t, n);
				} };
		}, function (e, t) {
			var n = { NUMBER: "NUMBER", BOOLEAN: "BOOLEAN", STRING: "STRING", NULL: "NULL", UNDEFINED: "UNDEFINED", DATE: "DATE", ARRAY: "ARRAY", MAP: "MAP", SET: "SET", ITERABLE_OBJECT: "ITERABLE_OBJECT", DEFAULT: "OBJECT" };e.exports = { types: n, iterableTypes: [n.ITERABLE_OBJECT, n.MAP, n.ARRAY, n.SET], errors: { EMPTY_DIFF: "No diff object is provided, Nothing to apply", INVALID_DIFF_FORMAT: "Invalid diff format", INVALID_DIFF_OP: "Unsupported operation provided into diff object" } };
		}, function (e, t) {
			var n = function n(e) {
				return function (t) {
			...
			};e.exports = { isNumber: function isNumber(e) {
					return "number" == typeof e;
				}, isBoolean: function isBoolean(e) {
					return "boolean" == typeof e;
				}, isString: function isString(e) {
					return "string" == typeof e;
				}, isDate: r, isUndefined: function isUndefined(e) {
					return void 0 === e;
				}, isNull: function isNull(e) {
					return null === e;
				}, isArray: o, isMap: i, isSet: l, isIterableObject: f, noop: function noop() {}, areDatesEqual: function areDatesEqual(e, t) {
					return e.getTime() === t.getTime();
				}, setValueByPath: function setValueByPath(e) {
					var t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
					var n = arguments[2];
					var r = arguments[3];
					if (!o(t)) throw new Error('Diff path: "' + t + '" is not valid');var i = t.length;
					if (0 === i) return n;var l = e;for (var _o2 = 0; _o2 < i; _o2 += 1) {
						var _f2 = t[_o2];if (!l) throw new Error('Invalid path: "' + t + '" for object: ' + JSON.stringify(e, null, 2));if (null == _f2) throw new Error('Invalid path: "' + t + '" for object: ' + JSON.stringify(e, null, 2));_o2 !== i - 1 ? (l = l[_f2], r && r(l)) : l[_f2] = n;
					}return e;
				}, deleteValueByPath: function deleteValueByPath(e, t) {
					var n = t || [];if (0 === n.length) return;var r = e;var o = n.length;
					for (var _i2 = 0; _i2 < o; _i2 += 1) {
						if (_i2 !== o - 1) {
							if (!r[n[_i2]]) throw new Error('Invalid path: "' + t + '" for object: ' + JSON.stringify(e, null, 2));r = r[n[_i2]];
						} else if (f(r)) delete r[n[_i2]];else {
							var _e = parseInt(n[_i2], 10);for (; r.length > _e;) {
								r.pop();
							}
						}
					}return e;
