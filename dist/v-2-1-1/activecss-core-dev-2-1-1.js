...
_a.ClickOnNextCycle = o => { _a.FocusOn(o, 'nc'); };		//	Next selector in list, then cycles

_a.ClickOnPrevious = o => { _a.FocusOn(o, 'p'); };		//	Previous selector in list

_a.ClickOnPreviousCycle = o => { _a.FocusOn(o, 'pc'); };	//	Previous selector in list, then cycles
...
_a.CreateCommand = o => {
	...
	funcContent = 'let actionName = o.actName,' +	// The name of the action command that called this function.
		...
		'_activeVarScope = (o.shadowRef) ? o.shadowRef : "main";' +
...
_a.FocusOnFirst = o => { _a.FocusOn(o); };				//	First selector in list

_a.FocusOnLast = o => { _a.FocusOn(o, 'l'); };			//	Last selector in list

_a.FocusOnNext = o => { _a.FocusOn(o, 'n'); };			//	Next selector in list, or nothing

_a.FocusOnNextCycle = o => { _a.FocusOn(o, 'nc'); };		//	Next selector in list, then cycles

_a.FocusOnPrevious = o => { _a.FocusOn(o, 'p'); };		//	Previous selector in list

_a.FocusOnPreviousCycle = o => { _a.FocusOn(o, 'pc'); };	//	Previous selector in list, then cycles
...
ActiveCSS.first = sel => { return _a.FocusOn({ actVal: sel }, null, true); };				//	First selector in list

ActiveCSS.last = sel => { return _a.FocusOn({ actVal: sel }, 'l', true); };				//	Last selector in list

ActiveCSS.next = sel => { return _a.FocusOn({ actVal: sel }, 'n', true); };				//	Next selector in list, or nothing
...
ActiveCSS.previous = sel => { return _a.FocusOn({ actVal: sel }, 'p', true); };			//	Previous selector in list
...
const _addScopedAttr = (wot, o, originalStr, walker) => {
	let cid = _addScopedCID(wot, o.secSelObj);
